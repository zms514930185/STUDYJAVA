...
//    姓名模糊查找
    @RequestMapping(value = "/a/u/user/like", method = RequestMethod.GET)
    public ModelAndView getUserByUsername(String username,Long roleId,Page page){
        logger.info("[logger]"+username);
        logger.info("[logger]"+roleId);
        ModelAndView mav = new ModelAndView();
        UserExample example = new UserExample();
        UserExample.Criteria criteria = example.createCriteria();
