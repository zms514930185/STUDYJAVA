...
//        String accessKeyId = aliSmsBean.getAccessKeyId();
//        String accessKeySecret = aliSmsBean.getAccessKeySecret();
    ...
    public SendSmsResponse sendSms(String telephone, String code) throws ClientException {
     ...
     String accessKeySecret = aliSmsBean.getAccessKeySecret();
        ...
        if(sendSmsResponse.getCode()!= null && "OK".equals(sendSmsResponse.getCode())){
            ...
            System.out.println("[logger]######短信发送失败！#######");
        }
        return sendSmsResponse;
    }


    public boolean isSend(SendSmsResponse sendSmsResponse){
