    ...
    <div style="background-color: #ffffff;border: 1px solid #999999;width: 400px;height: 350px;display: flex;justify-content: center">
        ...
        <form action="/a/login" method="post">
            ...
            <div style="margin-bottom: 20px;margin-top: 20px">
                <input style="height: 50px;width: 250px;font-size: large" type="text" name="mobileOrEmail" value="${mobileOrEmail}" placeholder="请输入手机号或邮箱..">
            </div>
            <div style="margin-bottom: 20px">
                <input style="height: 50px;width: 250px;font-size: large" type="password" name="password" value="${password}" placeholder="请输入登陆密码..">
            </div>
            ...
            <div style="margin: 10px 10px 0 180px"><a style="font-size: small;color: #999999" href="/a/code">立即注册</a></div>
        </form>
